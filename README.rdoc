...
The passwords are validated using 'has_secure_password' method. This requires us to have a password_digest attribute. Which I created earlier in the migration 'create_users'.
